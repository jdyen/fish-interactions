...
# load data sets
cpue <- fetch_fish(target = "northern", recompile = reload_data)
...
corr_sp_hier_plot <- cor_sp$id_site |>
  mutate(
    ...
    name1 = gsub("Maccullochella", "Maccullochella ", name1),
    name1 = gsub("Macquaria", "Macquaria ", name1),
    name1 = gsub("Carp", "Carp/ ", name1),
    name1 = gsub("Melanotaenia", "Melanotaenia ", name1),
    name1 = gsub("Perca", "Perca ", name1),
    name1 = gsub("Retropinna", "Retropinna ", name1),
    name2 = gsub("Maccullochella", "Maccullochella ", name2),
    name2 = gsub("Macquaria", "Macquaria ", name2),
    name2 = gsub("Carp", "Carp/ ", name2),
    name2 = gsub("Melanotaenia", "Melanotaenia ", name2),
    name2 = gsub("Perca", "Perca ", name2),
    name2 = gsub("Retropinna", "Retropinna ", name2),
